	...
	<div class="col-md-10">
		<div class="box box-success">
			<div class="box-header with-border">
                  <h3 class="box-title"><i class="fa fa-bars fa-fw"></i>Laporan Data Transaksi Bahan Keluar</h3>
            </div>
			<div class="box-body">
				<div class="row">
				...
				<?php
					if(isset($_POST['cari'])){
						...
						$query = $db->prepare("SELECT far_keluar.id_keluar, far_keluar.tgl, far_keluar.id_barang, far_keluar.jml, far_barang.nama_barang, far_barang.nama_satuan FROM far_keluar
						LEFT JOIN far_barang ON far_keluar.id_barang=far_barang.id_barang WHERE far_keluar.tgl LIKE '%".$bulan."%' AND far_keluar.tgl LIKE '%".$tahun."%'
						AND far_barang.nama_barang LIKE '%".$nm_brg."%' GROUP BY far_keluar.id_keluar ASC");
						$query->execute();
						$num = $query->rowCount();
						if($num == 0){
							echo "
				...
				?>
					<form name="cek" method="post" action="cetak/CtkOut.php" target="_blank">
						...
						<div class="row">							
							<div style="margin-left:10px">Hasil pencarian untuk Transaksi Bahan Keluar bulan 
								<?php 
						...
						<table style="font-size:13px" class="table table-bordered table-hover">
							...
							<tbody>
								...
								?>
									<tr>
										<td class="text-center"><input type="checkbox" class="check" name="cek[]" value="<?php echo $cr['id_keluar'];?>"></td>
										<td><?php echo $urut++;?></td>
